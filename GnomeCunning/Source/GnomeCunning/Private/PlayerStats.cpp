...
UPlayerStats::UPlayerStats(): CurrentHealth(100), MaxHealth(100), CurrentStamina(100), MaxStamina(100), CurrentXP(0), MaxXP(1000),
                              Level(1),
                              Vigor(0),
...
void UPlayerStats::LevelUp(int32 newVigor, int32 newEndurance, int32 newFitness, int32 newMind)
{
	Level++;
	Vigor = newVigor;
