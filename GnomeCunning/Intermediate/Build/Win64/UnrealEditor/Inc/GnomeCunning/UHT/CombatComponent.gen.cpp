...
#include "GnomeCunning/Public/CombatComponent.h"
...
GNOMECUNNING_API UClass* Z_Construct_UClass_UCombatComponent();
GNOMECUNNING_API UClass* Z_Construct_UClass_UCombatComponent_NoRegister();
GNOMECUNNING_API UEnum* Z_Construct_UEnum_GnomeCunning_EMovementDirection();
...
static UEnum* EMovementDirection_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EMovementDirection.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_GnomeCunning_EMovementDirection, (UObject*)Z_Construct_UPackage__Script_GnomeCunning(), TEXT("EMovementDirection"));
	}
...
struct Z_Construct_UEnum_GnomeCunning_EMovementDirection_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_GnomeCunning_EMovementDirection_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_GnomeCunning,
	nullptr,
	"EMovementDirection",
	"EMovementDirection",
	Z_Construct_UEnum_GnomeCunning_EMovementDirection_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_GnomeCunning_EMovementDirection_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_GnomeCunning_EMovementDirection_Statics::Enum_MetaDataParams), Z_Construct_UEnum_GnomeCunning_EMovementDirection_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_GnomeCunning_EMovementDirection()
{
	if (!Z_Registration_Info_UEnum_EMovementDirection.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EMovementDirection.InnerSingleton, Z_Construct_UEnum_GnomeCunning_EMovementDirection_Statics::EnumParams);
	}
...
template<> GNOMECUNNING_API UClass* StaticClass<UCombatComponent>()
{
	return UCombatComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_GnomeCunning_Source_GnomeCunning_Public_CombatComponent_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCombatComponent, UCombatComponent::StaticClass, TEXT("UCombatComponent"), &Z_Registration_Info_UClass_UCombatComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombatComponent), 3124273798U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GnomeCunning_Source_GnomeCunning_Public_CombatComponent_h_3358552643(TEXT("/Script/GnomeCunning"),
